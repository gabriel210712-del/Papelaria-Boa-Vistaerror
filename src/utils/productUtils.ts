...
export const CLEAN_PRODUCT_IMAGES: Record<string, string> = {
  ...
  'lapis-de-cor-36-cores-faber-castell-ecolapis': '/product-images/lapis-de-cor-36-cores-faber-castell-ecolapis.png',
  'lapis-de-cor-48-cores-faber-castell-ecolapis': '/product-images/lapis-de-cor-48-cores-faber-castell-ecolapis.png',
